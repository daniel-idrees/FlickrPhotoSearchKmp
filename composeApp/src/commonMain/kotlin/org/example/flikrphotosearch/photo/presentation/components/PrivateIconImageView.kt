...
import flickrphotosearch.composeapp.generated.resources.ic_private
import flickrphotosearch.composeapp.generated.resources.search_screen_result_photo_private_icon_tooltip_text
...
internal fun PrivateIconImageView(modifier: Modifier = Modifier) {
    val publicPainterResource =
        painterResource(Res.drawable.ic_private)
    ...
    TooltipBox(
        ...
        tooltip = {
            Surface(
                ...
                Text(
                    text = stringResource(Res.string.search_screen_result_photo_private_icon_tooltip_text),
